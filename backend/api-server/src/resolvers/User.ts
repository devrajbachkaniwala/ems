...
export class UserResolver {
  ...
  async createUser(
    ...
    const res: AxiosResponse<IUser> = await axios
      .post<IUser, AxiosResponse<IUser>, AddUserInput>(url, data)
      .catch((err: any) => {
  ...
  async reviews(@Root() parent: User): Promise<Review[] | undefined> {
    try {
  ...
  async bookings(@Root() parent: User): Promise<Booking[] | undefined> {
    try {
